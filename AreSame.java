...
public class AreSame {
    ...
    HashMap<Integer,Integer> freqMapA= new HashMap<Integer,Integer>();
    HashMap<Integer,Integer> freqMapB= new HashMap<Integer,Integer>();
    if(a==null || b==null) return false;
    
    for(int num : a){
      num = Math.abs(num);
      if(freqMapA.containsKey(num)){
     ...
     for(int num : b){
      ...
      if(freqMapB.containsKey(num)){
        freqMapB.put(num,freqMapB.get(num)+1);
      }else{
        freqMapB.put(num,1);
      }
    }
